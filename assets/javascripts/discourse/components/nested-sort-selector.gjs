...
const NestedSortSelector = <template>
  <div class="nested-sort-selector">
    <span class="nested-sort-selector__label">{{i18n
        "discourse_nested_replies.sort.label"
      }}</span>
    <DButton
      class={{concatClass
      ...
      @translatedLabel={{i18n "discourse_nested_replies.sort.top"}}
    />
    <DButton
      class={{concatClass
        "btn-flat nested-sort-selector__option"
      ...
      @translatedLabel={{i18n "discourse_nested_replies.sort.new"}}
    />
    <DButton
      class={{concatClass
        "btn-flat nested-sort-selector__option"
      ...
      @translatedLabel={{i18n "discourse_nested_replies.sort.old"}}
    />
  </div>
</template>;
