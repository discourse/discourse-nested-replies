...
module ::DiscourseNestedReplies
  ...
  #
  # Options:
  #   exclude_deleted: true  — skip soft-deleted posts (for create-path logic)
  #   exclude_deleted: false — include deleted posts (for destroy-path cleanup)
  #   stop_at_op: true       — stop before walking into OP (post_number 1)
  #   stop_at_op: false      — include OP if it's in the chain
